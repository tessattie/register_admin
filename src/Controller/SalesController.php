...
class SalesController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['Users', 'Customers', 'Pointofsales', 'Rates'],
        ];
    ...
    public function view($id = null)
    {
        $sale = $this->Sales->get($id, [
            'contain' => ['Users', 'Customers', 'Pointofsales', 'Rates', 'Payments', 'Products'],
        ]);
    ...
    public function add()
    {
        ...
        $rates = $this->Sales->Rates->find('list', ['limit' => 200]);
        $payments = $this->Sales->Payments->find('list', ['limit' => 200]);
        $products = $this->Sales->Products->find('list', ['limit' => 200]);
        $this->set(compact('sale', 'users', 'customers', 'pointofsales', 'rates', 'payments', 'products'));
    }
