        ...
        <?= $this->Flash->render() ?>
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Categories </h4><a href="<?= ROOT_DIREC ?>/categories/add" style="float:right"><button class="btn btn-warning" style="padding:10px 15px;font-size:18px"><i class="feather icon-plus"></i></button></a>
                </div>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <?php $i=1; foreach($categories as $category) : ?>
                                        <tr <?= ($id == $category->id) ? "style='background:green'" : "" ?>>
                                        <td><?= $i ?></td>
                                        <td><a href="<?= ROOT_DIREC ?>/categories/edit/<?= $category->id ?>"><?= $category->name ?></a></td>
                                        <td class="text-right"><a href="<?= ROOT_DIREC ?>/categories/edit/<?= $category->id ?>"><span class="badge badge-info" style='font-size:18px'><i class="feather icon-edit-1"></i></span></a></td>
                                        </tr>
                                        <?php $i++ ?>
                                    <?php endforeach; ?>
                                </tbody>
